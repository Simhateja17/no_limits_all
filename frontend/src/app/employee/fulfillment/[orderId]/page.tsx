...
export default function EmployeeFulfillmentOrderDetailPage() {
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <button
              onClick={() => router.push('/employee/fulfillment')}
              style={{
                width: '40px',
                height: '40px',
                borderRadius: '8px',
            ...
            <div>
              ...
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', color: '#6B7280', marginTop: '4px' }}>
                {order.channel?.name} - {order.client?.companyName} - Created {new Date(order.createdAt).toLocaleDateString()}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            {order.status === 'ON_HOLD' ? (
              ...
              <>
                ...
                <button
                  onClick={() => router.push(`/employee/fulfillment/workflow?orderId=${order.id}`)}
                  style={{
                    padding: '10px 20px',
                    borderRadius: '8px',
